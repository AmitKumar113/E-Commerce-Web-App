    ...
    <div className="min-h-[80vh] flex justify-center items-center my-12">
      <div className=" flex flex-col justify-center w-1/3 pt-4 bg-slate-300">
        ...
        <div className=" flex justify-center ">
          <div className={`w-24 h-24 bg-slate-500 rounded-full bg-[url(${avatar})] bg-cover bg-center`}>
              {/* <img className="w-full h-full" src={avatar}></img> */}
          </div>
        </div>
        ...
        >
          <input name="file" type='file' onChange= {(e)=> registerDataChange(e)}></input>
